...
public final class BookmarkPickerActivity extends ListActivity {
  ...
  protected void onResume() {
    super.onResume();
    cursor = getContentResolver().query(/*Browser.BOOKMARKS_URI*/null, BOOKMARK_PROJECTION,
  ...
  protected void onListItemClick(ListView l, View view, int position, long id) {
    if (!cursor.isClosed() && cursor.moveToPosition(position)) {
      ...
      intent.putExtra(/*Browser.BookmarkColumns.TITLE*/null, cursor.getString(TITLE_COLUMN));
      intent.putExtra(/*Browser.BookmarkColumns.URL*/null, cursor.getString(URL_COLUMN));
